...
/**
 * 🎯 TOCA FOOTBALL HOME PAGE POM GENERATION (FIXED NAVIGATION)
 * 
 * This test fixes the navigation issue by:
 * 1. Login and wait for redirect
 * 2. Wait for all pages to load after login
 * 3. Manually navigate to home page using browser
 * 4. Wait for home page to completely load
 * 5. Download page DOM and send to AI
 * 6. Generate industry-standard POM with proper naming conventions
 */

async function testTocaFootballHomeFixedNavigation() {
  console.log('🎯 Testing Toca Football Home Page POM Generation (Fixed Navigation)');
  ...
  try {
    ...
    if (profilesResult.success) {
      ...
      console.log('\n🤖 Step 3: Manually navigate to home page using browser...');
...
if (require.main === module) {
  testTocaFootballHomeFixedNavigation().catch(console.error);
}

module.exports = { testTocaFootballHomeFixedNavigation }; 