...
/**
 * 🎯 TOCA FOOTBALL HOME PAGE POM GENERATION (FIXED)
 * 
 * This test ensures we properly navigate to the home page after login
 * and wait for it to load completely before extracting POM.
 */

async function testTocaFootballHomePageFixed() {
  console.log('🎯 Testing Toca Football Home Page POM Generation (Fixed)');
  ...
  try {
    ...
    if (profilesResult.success) {
      ...
      // Create a new generator instance with enhanced wait strategy
      ...
      const homeOptions = {
        ...
        customWaitStrategy: {
          type: 'networkidle',
          timeout: 15000,
          additionalWait: 5000 // Extra wait for dynamic content
        },
        mcpIntegration: {
          serverUrl: 'https://mcp-server.example.com',
          tools: ['generate_pom_with_ai'],
      ...
      console.log('🔍 This may take longer to ensure all dynamic content loads...');
      ...
      if (homeResult.success) {
        ...
        console.log('  • Enhanced page load waiting');
...
if (require.main === module) {
  testTocaFootballHomePageFixed().catch(console.error);
}

module.exports = { testTocaFootballHomePageFixed }; 