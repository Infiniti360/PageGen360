...
/**
 * 🎯 TOCA FOOTBALL HOME PAGE POM GENERATION (DIRECT NAVIGATION)
 * 
 * This test directly handles the complete flow:
 * 1. Login and wait for redirect
 * 2. Manually navigate to home page using browser
 * 3. Wait for home page to completely load
 * 4. Download page DOM and send to AI
 * 5. Generate industry-standard POM with proper naming conventions
 */

async function testTocaFootballHomeDirectNavigation() {
  console.log('🎯 Testing Toca Football Home Page POM Generation (Direct Navigation)');
  ...
  try {
    ...
    if (profilesResult.success) {
      ...
      console.log('\n🤖 Step 2: Manually navigate to home page using browser...');
...
if (require.main === module) {
  testTocaFootballHomeDirectNavigation().catch(console.error);
}

module.exports = { testTocaFootballHomeDirectNavigation }; 