...
async function correctedTocaFlow() {
  console.log('🎯 Corrected Toca Football Flow');
  ...
  try {
    ...
    console.log('🔄 Correct Flow: Navigate to Home → Redirect to Auth → Login → Profiles → Home');
    ...
    if (result.success) {
      ...
      console.log('✅ Step 3: Redirect to /profiles (profile selection)');
      console.log('✅ Step 4: Navigate to /home (actual home page)');
...
// Run the example
correctedTocaFlow().catch(console.error); 